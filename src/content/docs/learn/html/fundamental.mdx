...
**HTML (HyperText Markup Language)** adalah blok bangunan paling dasar (pondasi) dari Web. Ini mendefinisikan makna dan struktur konten web. Teknologi lain selain HTML umumnya digunakan untuk menggambarkan tampilan halaman web yaitu **CSS** dan fungsionalitas yaitu **JavaScript**.

## Struktur Dokument HTML
