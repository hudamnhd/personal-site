...
## What is Linux?
Linux® is an open-source operating system (OS) created by Linus Torvalds in 1991.
Linux has several famous distributions, namely Debian, Ubuntu, Arch, Fedora etc.
...
- No forced updates.
- No spyware.
- Easy installation of apps/packages.
- More lightweight.
